...
<body>
    ...
    <!-- SCRIPTS -->
    <!-- JQuery -->
    <script type="text/javascript" src="wp-content/themes/leyreley_custom/js/jquery-3.4.1.min.js"></script>
    <!-- Bootstrap tooltips -->
    <script type="text/javascript" src="wp-content/themes/leyreley_custom/js/popper.min.js"></script>
    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="wp-content/themes/leyreley_custom/js/bootstrap.min.js"></script>
    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="wp-content/themes/leyreley_custom/js/mdb.min.js"></script>
    <!-- Initializations -->
